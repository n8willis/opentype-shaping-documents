...
> Note: Gurmukhi does not include the Anudatta (`U+0952`). It is
...
For `<gur2>` text, the canonical ordering means that any "Nukta"s must
...
<!---  *** Gurmukhi does not use pre-base reordering consonants *** *** This
