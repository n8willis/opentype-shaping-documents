...
#
    ...
    def write(self, filename_stub=self.name, file_extesion="svg.in"): # To write to an intermediate file
        if filename_stub:
...
#
                    ...
                    for component in config["components"]:
                        for key in component.keys():
                            ...
                            #print(f'component {component_name} = structure: {component[key]}')
                            if "file" in component_structure:
                            #if component_structure["file"]:
                                self.components.append(svgFileComponent(component_name, component_structure["file"])) # TODO: how to refer to this
                            else:
                                self.components.append(svgComponent(component_name,
                                                                    ...
                                                                    component_structure.get("options", None),     # add ["basecolor"] for overrides !!
                                                                    self.generator,
                                                                    self.basecolor
                                                                    ))
